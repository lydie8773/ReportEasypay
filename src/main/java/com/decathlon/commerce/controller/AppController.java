...
import com.decathlon.commerce.service.UserProfileService;
import com.decathlon.commerce.service.UserService;
...
public class AppController {
	...
	public String saveUser(@Valid User user, BindingResult result,
		 ...
		 * 
		 */
		if(!userService.isUserNameUnique(user.getUserid(), user.getName())){
			FieldError ssoError =new FieldError("user","ssoId",messageSource.getMessage("non.unique.userid", new String[]{user.getUserid()}, Locale.getDefault()));
